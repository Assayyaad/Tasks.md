      ...
      >
        <Show
          ...
          fallback={props.options.map((option) => (
            <button
              ...
              onKeyDown={(e) => handleKeyDown(e, () => handleOptionClick(option, true), props.onClose)}
            >
              {option.label}
            </button>
          ))}
        >
          <button
            ...
            onKeyDown={(e) => handleKeyDown(e, () => handleOptionConfirmation(e), close)}
          >
            Are you sure?
          </button>
          <button type="button" onClick={close} onKeyDown={(e) => handleKeyDown(e, close, close)}>
            Cancel
          </button>
        </Show>
      </div>
