  ...
  return (
    <>
      ...
      <div class="header-buttons">
        <button type="button" title="Create new card" class="small" onClick={() => props.onCreateNewCardBtnClick()}>
        ...
        <button
          ...
          onKeyDown={(e) => handleKeyDown(e, () => handleOptionsBtnClick(e, true), handleCancel)}
        >
